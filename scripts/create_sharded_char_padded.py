...
# ------------------------------------------
local_dir = "/gpfs/data/ranganathlab/Jatin/model_architecture_stuff/data/tinystories_char500m_zeropadded_mod15"
dataset_name = "karpathy/tinystories-gpt4-clean"
remote_name = None
shard_size = 100_000_000  # 500M tokens per shard
TOKENIZER_NAME = "bicycleman15/tinystories-gpt4-clean-tokenizer"  # "gpt2", "byte", or any HF tokenizer name
...
fw_test = fw["test"] # 20M test
fw = fw["train"]
fw = fw.shard(num_shards=4, index=0)  # first ~500M char tokens
